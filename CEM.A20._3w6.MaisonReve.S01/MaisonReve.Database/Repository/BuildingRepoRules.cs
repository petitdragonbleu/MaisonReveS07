...
namespace MaisonReve.Database.Repository
{
    public partial class BuildingRepo
    {
        ...
        public void ValidateMultipleBuildings(RentingLot rentingLot)
        {
            ...
            if (building.RentingLot.Any(x => x.RentingLotType == RentingLotType.FamilyHome || x.RentingLotType == RentingLotType.Townhouse))
        ...
        public void ValidateOnlyOneHouse(RentingLot rentingLot)
        {
            ...
            if (rentingLot.RentingLotType == RentingLotType.FamilyHome || rentingLot.RentingLotType == RentingLotType.Townhouse)
            {
                ...
                var alreadyHaveElements = building.RentingLot.Any(x => x.Id != rentingLot.Id);
        ...
        {
            //if (!building.RentingLot.Any()) building.Published = false;
        ...
        public void ValidateNoLinks(Building building)
        {
            ...
            if (building.RentingLot.Any()) throw new BuildingRepoException("Liens toujours présents. Merci de les supprimer avant de supprimer l'immeuble.");
